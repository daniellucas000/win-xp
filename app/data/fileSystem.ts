...
export const defaultFileSystem: FileSystemItem[] = [
  ...
  { id: 5, parentId: null, name: 'portfolio.txt', type: 'txt', icon: '/images/xp/icons/file-text.png', size: '2.1 KB', modified: '2024-01-15', content: 'Bem-vindo ao meu portfolio!\n\nEste é um clone do Windows XP feito com Vue 3, Nuxt e Pinia.\n\nTecnologias utilizadas:\n- Vue 3 (Composition API)\n- Nuxt 3\n- Pinia (state management)\n- Sass (estilos)\n\nDivirta-se explorando!' },
